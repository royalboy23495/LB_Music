...
MONGO_DB_URI = getenv("MONGO_DB_URI", mongodb+srv://royalboy001144:Rishabb10031977@@cluster0.jcznc3e.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0)
...
HEROKU_APP_NAME = getenv("valentinaxmusicbot55")
